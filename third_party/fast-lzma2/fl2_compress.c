...
// dict_size; overlap_fraction; chainLog; circlesLog; searchDepth; fast_length; divide_and_conquer; strategy
    { 0,0,0,0,0,0,0,0 },
    ...
    { 1024 MB /*3 << 29*/ /*512 MB*/, 4, 14, 5, 254, 273, 0, FL2_ultra } /* 10 */
};
...
FL2LIB_API size_t FL2LIB_CALL FL2_initCStream(FL2_CStream* fcs, int compressionLevel)
{
    ...
    fcs->wroteProp = 0;
    fcs->loopCount = 0;
    fcs->params.highCompression = 1; // use high compression parameter
